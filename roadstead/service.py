...
from .constants import _MIN_RETRY_BUDGET_S, _RETRY_BACKOFF_S
from .correction import (
    Correction,
    _ToolCallStreamSanitizer,
    _EMPTY_RESCUE_MIN_TOKENS,
    # Re-exported so `service._is_degenerate_text` / `service._top_shingle_reps`
    # stay importable (frozen test surface, contract §1) — used only via the
    # correction module at runtime, hence the noqa.
